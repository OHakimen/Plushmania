package com.roseisproot.plushmania.client.models;
...
public class PlushieModel extends Model {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Waist = partdefinition.addOrReplaceChild("Waist", CubeListBuilder.create(), PartPose.offset(0.0F, 22.0F, 5.0F));
		...
		.texOffs(40, 32).addBox(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.25F)), PartPose.offsetAndRotation(-5.0F, -10.0F, 0.0F, 0.0F, 0.0F, 0.3927F));

		PartDefinition LeftArm = Waist.addOrReplaceChild("LeftArm", CubeListBuilder.create().texOffs(32, 48).addBox(-1.0F, -12.0F, -7.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F))
		.texOffs(48, 48).addBox(-1.0F, -12.0F, -7.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.25F)), PartPose.offsetAndRotation(9.0F, -1.0F, 5.0F, 0.0F, 0.0F, -0.3927F));
		...
		.texOffs(0, 32).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.25F)), PartPose.offsetAndRotation(-1.9F, 22.0F, 5.0F, -1.5708F, 0.48F, 0.0F));
		...
		.texOffs(0, 48).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.25F)), PartPose.offsetAndRotation(1.9F, 22.0F, 5.0F, -1.5708F, -0.3927F, 0.0F));
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int rgba) {
		Waist.render(poseStack, vertexConsumer, packedLight, packedOverlay, rgba);
		RightLeg.render(poseStack, vertexConsumer, packedLight, packedOverlay, rgba);
		LeftLeg.render(poseStack, vertexConsumer, packedLight, packedOverlay, rgba);
	}
}